    ...
    <div class="wrapper"> 
        ...
        <section class="hero-section text-center text-white py-5" style="background: linear-gradient(to right, #6a11cb, #2575fc);">
            <div class="container">
                ...
                <!-- <p class="lead">Your digital space for seamless eTutoring experience.</p> -->
                <div>
                    <?php if (!$isLoggedIn): ?>
                        <a href="?url=login" class="btn btn-light btn-lg btn-custom">
                            <i class="bi bi-box-arrow-in-right"></i> Get Started
                        </a>
                    <?php elseif ($isTutor): ?>
                        <a href="?url=tutor/dashboard" class="btn btn-light btn-lg btn-custom">
                            <i class="bi bi-people"></i> View My Tutees
                        </a>
                    <?php endif; ?>
                </div>
